...
* Opacity - VB.NET are now available as the full object, however the current controls internally available are limited to simple tests only, ie Anchor, DockStyle can be tested on controls without an opacity property.
